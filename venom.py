...
ascii_art = r"""
     ...
     ╔══════════════════════════════════════════════╗                  ╔══════════════════════════════╗          
     ║ [1]  > Поиск по ноиеру ++                    ║                  ║ [55] > Установить все модули ║
...
def print_art(color=Fore.RED):
    clear_console()
    if color == "gradient_yellow_green":
        print(gradient_text(ascii_art, (255, 255, 0), (0, 255, 0)))
    elif color == "gradient_blue_purple":
        print(gradient_text(ascii_art, (0, 0, 255), (128, 0, 128)))
    elif color == "gradient_blue_red":
        print(gradient_text(ascii_art, (255, 0, 0), (50, 0, 205)))
    elif color == "gradient_red_orange":
...
def change_color():
    """Функция для изменения цвета интерфейса."""
    colors = {
        1: Fore.RED,
        2: Fore.GREEN,
        3: Fore.BLUE,
